...
std::array<float, 3> Triangle3D::computeNormal() {
    ...
    //Norm = Dir / len(Dir)
    auto dir = glm::cross(
            (glm::vec3{_vertices[1][0], _vertices[1][1], _vertices[1][2]} -
             glm::vec3{_vertices[0][0], _vertices[0][1], _vertices[0][2]}),
            (glm::vec3{_vertices[2][0], _vertices[2][1], _vertices[2][2]} -
             glm::vec3{_vertices[0][0], _vertices[0][1], _vertices[0][2]})
    );
