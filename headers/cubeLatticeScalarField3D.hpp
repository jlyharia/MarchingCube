...
CubeLatticeScalarField3D<sizeX, sizeY, sizeZ>::CubeLatticeScalarField3D(float gridSpacing,
                                                                        const dgr582::Point3D &gridCentre) :
...
template<size_t sizeX, size_t sizeY, size_t sizeZ>
std::array<size_t, 3>
CubeLatticeScalarField3D<sizeX, sizeY, sizeZ>::cellCornerIndexToIJKIndex(size_t vertexIndex, size_t i, size_t j,
                                                                         size_t k) {
...
unsigned int CubeLatticeScalarField3D<sizeX, sizeY, sizeZ>::polygoniseCell(
    ...
    if (edgeTable[cubeindex] & 1)
        vertlist[0] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(0, i, j, k),
                                        cellCornerIndexToIJKIndex(1, i, j, k));
    if (edgeTable[cubeindex] & 2)
        vertlist[1] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(1, i, j, k),
                                        cellCornerIndexToIJKIndex(2, i, j, k));
    if (edgeTable[cubeindex] & 4)
        vertlist[2] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(2, i, j, k),
                                        cellCornerIndexToIJKIndex(3, i, j, k));
    if (edgeTable[cubeindex] & 8)
        vertlist[3] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(3, i, j, k),
                                        cellCornerIndexToIJKIndex(0, i, j, k));
    if (edgeTable[cubeindex] & 16)
        vertlist[4] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(4, i, j, k),
                                        cellCornerIndexToIJKIndex(5, i, j, k));
    if (edgeTable[cubeindex] & 32)
        vertlist[5] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(5, i, j, k),
                                        cellCornerIndexToIJKIndex(6, i, j, k));
    if (edgeTable[cubeindex] & 64)
        vertlist[6] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(6, i, j, k),
                                        cellCornerIndexToIJKIndex(7, i, j, k));
    if (edgeTable[cubeindex] & 128)
        vertlist[7] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(7, i, j, k),
                                        cellCornerIndexToIJKIndex(4, i, j, k));
    if (edgeTable[cubeindex] & 256)
        vertlist[8] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(0, i, j, k),
                                        cellCornerIndexToIJKIndex(4, i, j, k));
    if (edgeTable[cubeindex] & 512)
        vertlist[9] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(1, i, j, k),
                                        cellCornerIndexToIJKIndex(5, i, j, k));
    if (edgeTable[cubeindex] & 1024)
        vertlist[10] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(2, i, j, k),
                                         cellCornerIndexToIJKIndex(6, i, j, k));
    if (edgeTable[cubeindex] & 2048)
        vertlist[11] = interpolateVertex(isoLevel, cellCornerIndexToIJKIndex(3, i, j, k),
                                         cellCornerIndexToIJKIndex(7, i, j, k));
